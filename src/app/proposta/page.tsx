                 ...
                 <div className="my-6">
                    ...
                    <ul className="space-y-2 text-sm text-center">
                        {plan.paymentOptions.map(opt => (
                           <li key={opt} className={`font-medium ${opt.includes('30% OFF') ? 'text-primary text-base font-bold' : ''}`}>{opt}</li>
                        ))}
                    </ul>
                </div>
              </CardContent>
            ...
            <Card className="bg-muted/30 border-dashed">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6 text-center">
                    <div className="bg-background/50 p-4 rounded-lg border">
                        ...
                        <p className="text-sm text-muted-foreground">(ou R$ 3.500 à vista com 30% OFF)</p>
                    </div>
                    <div className="bg-background/50 p-4 rounded-lg border">
